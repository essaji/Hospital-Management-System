<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%
		...
		if(!(username!=null && userType.equals("pharmacist")))
    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a href="pharmacistpanel.jsp?page=dashboard">Dashboard</a>
                </li>
                <li>
                    <a href="pharmacistpanel.jsp?page=dataMgmt">Data Management</a>
                </li>
                <li>
